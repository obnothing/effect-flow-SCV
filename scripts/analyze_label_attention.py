...
def main():
    ...
    config = merge_runtime_config(config, runtime)
    ...
    valid = LightLabelDataset(resolve(config["cache_dir"]) / f"valid_max{config['max_len']}.pt", runtime_max_len=config["max_len"])
